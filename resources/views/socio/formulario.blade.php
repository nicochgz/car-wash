...
<div id="app" class="row">
    <form enctype="multipart/form-data" action="{{action('SocioController@save')}}" method="POST">
      ...
      <!-- PROBABLEMENTE TENGA QUE AGREGAR ESTO EN LOS FORMULARIOS
      <input type="hidden" name="idtiposocio" class="form-control" value="{{$socio->idtiposocio}}"> -->
      ...
      <div class="form-group">
        ...
        <select name="idtiposocio" v-model="idtiposocio" id="" class="form-control">
      ...
      new Vue({
        ...
        ,methods:{
          ...
          validar_formulario:function(event){
            ...
            if(this.idtiposocio==''){
              this.bandera=1;
              this.mensaje+=' El tipo de socio no puede estar vacío';
            }
